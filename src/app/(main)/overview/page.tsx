                ...
                {TASK_FILTERS.map(f => (
                  <button key={f.key} onClick={() => setFilter(f.key)}
                    className={cn(
                      ...
                      filter === f.key ? 'bg-gray-900 dark:bg-gray-700 text-white border-transparent' : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-400 hover:border-gray-400 dark:hover:border-gray-400'
                    )}
                  >
                    {f.label}
                    {f.count > 0 && (
